...
import com.cc.notes.adapter.FirsthomeViewAdapterAdapter;
...
import com.cc.notes.utils.FirsthomeViewHelper;
...
public class FirsthomeActivity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener,ViewPager.OnPageChangeListener,ViewPager.OnTouchListener{
...
//    private Fragment fragment_now = null;
    FirsthomeViewAdapterAdapter pagerAdapter;
    ...
    private void inint() {
        ...
        FirsthomeViewHelper.disableShiftMode(bottomNavigationView);//改变 BottomNavigationView 默认的效果
        //选中第一个item,对应第一个fragment
        bottomNavigationView.setSelectedItemId(R.id.item_1);

        pagerAdapter = new FirsthomeViewAdapterAdapter(getSupportFragmentManager(),fragments);
